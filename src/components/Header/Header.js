...
export default function Header() {
  return (
    <header className="flex justify-between relative md:justify-center">
        <div className='flex sl:w-full sl:relative sl:z-40 z-20'>
            <div className='mr-[44px] lg:hidden'>
            ...
            <nav className='relative pt-1 px-2 sl:p-0 sl:w-full'>
                <ul className='flex justify-between font-inter text-lg gap-[31.3px] midl:gap-4 midl:text-sm sl:px-4 sl:py-5 sl:w-full sl:uppercase sl:bg-[#0E1014]'>
                ...
                <div className='w-[83px] h-[83px] absolute right-[48%] bg-header-ball-gradient rounded-full shadow-3xl sl:hidden'></div>
            </nav>
        </div>
   
        <div className='flex pt-1 lg:hidden'>
            <CallNumber/>
            <ul className='ml-[48px] flex justify-end gap-[29px]'>
                <SocialMedia/>
            </ul>
        </div>
