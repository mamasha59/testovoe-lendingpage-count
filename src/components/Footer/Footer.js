...
export default function Footer() {
  return (
    <footer className='flex flex-col items-end font-inter text-lg pb-5 md:justify-center md:items-start sl:px-[15px] sl:text-[14px] sl:leading-[17px] sl:relative sl:z-20 sl:pt-10'>
        ...
        <div className='flex max-w-[239px] font-montserrat font-normal text-[12px] leading-[15px] text-right md:justify-start md:text-left'>
            <p className='flex flex-col items-end' title='Политика конфиденциальности' aria-label='Политика конфиденциальности'>©WELBEX 2022. Все права защищены. <br/>
                <span className='flex mt-1 underline'><a href="/#"> Политика конфиденциальности</a></span>
            </p>
        </div>
    </footer>
  )
